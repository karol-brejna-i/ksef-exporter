...
- Read `design/DEPLOYMENT_CONTEXT.md` (or `design/DOCKER_DEPLOYMENT_PLAN.md` if that doesn't exist yet) before touching deployment, Docker, or anything under `deploy/`.
